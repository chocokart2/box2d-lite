...
void OurJoint::Set(OurBody* b1, OurBody* b2, const V2& anchor)
{
	OurBody1 = b1;
	OurBody2 = b2;

	M22 Rot1(body1->rotation);
	M22 Rot2(body2->rotation);
	M22 Rot1T = Rot1.Transpose();
	M22 Rot2T = Rot2.Transpose();
...
void OurJoint::PreStep(float inv_dt)
{
	...
	V2 p1 = body1->position + r1;
	V2 p2 = body2->position + r2;
	V2 dp = p2 - p1;

	if (OurWorld::positionCorrection)
	{
...
void OurJoint::ApplyImpulse()
{
	V2 dv = body2->velocity + Cross(body2->angularVelocity, r2) - body1->velocity - Cross(body1->angularVelocity, r1);
